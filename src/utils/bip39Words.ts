// Standard BIP-39 English Word List snippet for seed phrase auto-complete & validation
export const BIP39_ENGLISH_WORDS = [
  ...
  "base", "basic", "basket", "battle", "beach", "beacon", "bean", "beauty", "because", "become",
  ...
  "deal", "debate", "debris", "decade", "december", "decide", "decline", "decor", "decrease", "deer",
  ...
  "injury", "inmate", "inner", "innocent", "input", "inquiry", "insect", "inside", "inspire", "install",
  ...
  "police", "policy", "poll", "ponder", "pony", "pool", "popular", "portion", "position", "possible",
  ...
  "sand", "satisfy", "satoshi", "saturn", "sauce", "save", "say", "scale", "scan", "scare",
  "scatter", "scene", "scheme", "school", "science", "scissors", "scorpion", "scout", "scrap", "scream",
  ...
  "tattoo", "tiger", "tilt", "timber", "time", "tiny", "tip", "tired", "tissue", "title",
  ...
  "valuable", "valve", "van", "vanish", "vapor", "various", "vast", "vault", "vehicle", "velvet",
  "vendor", "venture", "venue", "verb", "verify", "version", "very", "vessel", "veteran", "viable",
  "vibrant", "vicious", "victory", "video", "view", "village", "vintage", "violin", "virtual", "virtue",
  "virus", "visa", "visit", "visual", "vital", "vivid", "vocal", "voice", "void", "volcano",
  "volume", "vote", "vowel", "voyage", "wage", "wagon", "wait", "walk", "wall", "walnut",
  ...
  "wide", "width", "wife", "wild", "will", "win", "window", "wine", "wing", "winner",
...
export function isValidBip39Word(word: string): boolean {
  return BIP39_ENGLISH_WORDS.includes(word.toLowerCase().trim());
}

// Word suggestion for autocomplete
export function getWordSuggestions(prefix: string, max: number = 5): string[] {
  if (!prefix || prefix.length < 2) return [];
  const clean = prefix.toLowerCase().trim();
  return BIP39_ENGLISH_WORDS.filter(w => w.startsWith(clean)).slice(0, max);
}
